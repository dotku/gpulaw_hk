...
export default function AIChat() {
  const [messages, setMessages] = useState<Message[]>([
    {
      role: 'assistant',
      content: "您好！我係理查德法律 AI，您嘅法律助手。我可以幫您解答有關婚姻家庭、僱傭糾紛、物業糾紛、合約糾紛、交通意外同知識產權嘅問題。我今日可以點樣幫到您？\n\n*請注意：我提供一般法律資訊，而非專業法律意見。對於具體法律事務，您應諮詢持牌律師。*",
      timestamp: new Date(),
    },
  ]);
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setMessages((prev) => {
        ...
        newMessages[assistantMessageIndex] = {
          role: 'assistant',
          content: '抱歉，我遇到咗錯誤。請重試，如果問題持續存在，請聯絡支援團隊。',
          timestamp: new Date(),
        };
        return newMessages;
      });
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-white rounded-xl sm:rounded-2xl shadow-2xl border-2 border-gray-200 overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-blue-900 to-blue-700 px-4 sm:px-6 py-3 sm:py-4 flex items-center gap-3 sm:gap-4">
            ...
            <div className="min-w-0 flex-1">
              <h3 className="text-white font-bold text-base sm:text-lg truncate">理查德法律 AI</h3>
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
                <p className="text-blue-100 text-xs sm:text-sm">在線 • 隨時為您服務</p>
              </div>
            </div>
          </div>
                ...
                >
                  {message.role === 'assistant' && (
                    <div className="flex items-center gap-2 mb-2 pb-2 border-b border-gray-200">
                      ...
                      <span className="text-xs font-semibold text-gray-600">理查德法律 AI</span>
                    </div>
                  )}
          ...
          <div className="h-[140px] sm:h-[160px] border-t-2 border-gray-200">
            <div className="px-3 py-3 sm:px-4 sm:py-4 md:px-6 md:py-4 bg-blue-50 h-full overflow-y-auto">
              <p className="text-xs sm:text-sm font-semibold text-gray-700 mb-2 sm:mb-3">建議問題：</p>
          ...
          <form onSubmit={handleSubmit} className="p-3 sm:p-4 md:p-6 bg-white border-t-2 border-gray-200">
            ...
            <p className="text-xs text-gray-500 mt-2 sm:mt-3 text-center leading-relaxed">
              此對話提供一般法律資訊，而非法律意見。如需個人化指導，請諮詢持牌律師。
            </p>
          </form>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          <div className="bg-white rounded-xl p-6 shadow-lg border-2 border-gray-200 text-center">
            ...
            <h4 className="font-bold text-gray-900 mb-2">24/7 全天候服務</h4>
            <p className="text-sm text-gray-600">隨時獲得即時法律指導，日夜無休</p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-2 border-gray-200 text-center">
            ...
            <p className="text-sm text-gray-600">您嘅對話內容私密且加密</p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg border-2 border-gray-200 text-center">
            ...
            <h4 className="font-bold text-gray-900 mb-2">專業知識</h4>
            <p className="text-sm text-gray-600">基於大量法律資源同案例法進行訓練</p>
          </div>
        </div>
      </div>
    </section>
